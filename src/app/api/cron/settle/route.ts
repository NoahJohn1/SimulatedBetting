 ...
 *
 * Lead-change detection and overdue-event sweeping ride along here rather than in their own
 * cron entries: settlement is what moves standings, and folding them in means no new schedules
 * to keep in sync.
 */
