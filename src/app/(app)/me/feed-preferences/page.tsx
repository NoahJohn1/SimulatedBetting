...
const OPTIONS: PreferenceOption[] = [
  ...
  },
  {
    ...
    description: 'When somebody opens a custom event',
  },
  {
    type: 'CUSTOM_EVENT_RESOLVED',
    label: 'Events resolved',
    description: 'How custom events were called',
  },
  {
    type: 'CUSTOM_EVENT_DISPUTED',
    label: 'Events disputed',
    description: 'When somebody questions a call',
  },
  {
    type: 'CUSTOM_EVENT_VOIDED',
    label: 'Events voided',
    description: 'Events an admin voided and refunded',
  },
  {
    type: 'CUSTOM_EVENT_OVERDUE',
    label: 'Overdue events',
    description: 'Events past their resolve-by date',
  },
];
