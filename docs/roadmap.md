...
| 6   | [Production deployment](#6--production-deployment)            | 🔄 Partial — deployed, unmonitored | [CLOUD] [NOAH]           | [spec](specs/2026-09-02-production-deployment-design.md)                                                                                                   |
...
[production deployment spec](specs/2026-09-02-production-deployment-design.md), which covers the
four `[CLOUD]` rows below and nothing else. The `[NOAH]` rows are unchanged by it, and none of them
