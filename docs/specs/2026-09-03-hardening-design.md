...
**The decision log is at D62, not D56.** D57 landed with the Dependabot-majors record and D58–D62
with the production-deployment work. This design's entries are **D63–D67**. This is the same
correction the phase 6 spec had to make — the number in a brief is a snapshot, and the log moves.
...
Five entries, D63–D67, recorded in [`decisions.md`](../decisions.md) in the commit that lands this
spec:

| #   | Decision                                                                                                                                                                                   |
| --- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| D63 | [Rate limiting is a Postgres fixed-window counter, enforced at the action boundary](../decisions.md#d63--rate-limiting-is-a-postgres-fixed-window-counter-enforced-at-the-action-boundary) |
| D64 | [The rate limiter fails open and counts attempts, not successes](../decisions.md#d64--the-rate-limiter-fails-open-and-counts-attempts-not-successes)                                       |
| D65 | [The four gate screens are one sequence on one component](../decisions.md#d65--the-four-gate-screens-are-one-sequence-on-one-component)                                                    |
| D66 | [The house rules page is public and lives outside the app shell](../decisions.md#d66--the-house-rules-page-is-public-and-lives-outside-the-app-shell)                                      |
| D67 | [The smoke checklist ships unvalidated, with a run log](../decisions.md#d67--the-smoke-checklist-ships-unvalidated-with-a-run-log)                                                         |
