...
All four subsystems are built end-to-end and verified: `npm run verify` passes clean (74 test
files / 578 tests, 0 lint errors), and `npm run build` compiles every route. See
